...
class ParkingSystem:
    ...
    def __init__(self, big: int, medium: int, small: int):
        self.park = {1: {"capacity": big, "used": 0},
                     2: {"capacity": medium, "used": 0},
                     3: {"capacity": small, "used": 0}}

    def addCar(self, carType: int) -> bool:
        if self.park[carType]['capacity'] == self.park[carType]['used']:
            return False
        self.park[carType]["used"] += 1
        return True
